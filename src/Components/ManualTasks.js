        ...
        if (newCountdown <= 0) {
          ...
          setModalMessage(
            ...
            <div className="w-full items-center justify-center flex flex-col space-y-2">
              ...
              <p className='font-medium text-center'>Please wait 30 minutes for moderation to review your task and unlock the bonus claim.</p>
            </div>
            <p className="pb-6 text-[#9a96a6] text-[15px] w-full text-center">
            Ensure the task is completed within 30 minutes to be eligible for your bonus!
            </p>
          </div>
          );
          setModalOpen(true);
    ...
    try {
      ...
      setModalMessage(
        ...
        <h3 className="font-medium text-[20px] text-[#ffffff] pt-2 pb-2">
          <span className={`text-accent`}>+{formatNumberCliam(task.bonus)}</span> $TRACEX CLAIMED
        </h3>
