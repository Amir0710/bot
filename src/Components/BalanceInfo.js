  ...
  return (
        ...
        <div ref={infoRef} className={`w-full bg-divider shadowtop rounded-tl-[40px] rounded-tr-[40px] relative flex flex-col ease-in duration-300 transition-all justify-center`}>
         ...
         <div className='w-full rounded-[16px] relative px-4 flex flex-col justify-center items-center'>
          ...
          <GiReceiveMoney className="text-[#f5bb5f] w-[34px] h-[34px]" />
        </div>
            ...
            <h3 className="font-bold text-[22px] text-[#ffffff] pt-2 pb-3 mt-[4px]">
              <span className='text-primary'>Increase your profit</span>
            </h3>
            </div>

            <p className="pb-6 text-[#bfbfbf] px-4 text-[14px] w-full text-center">
            Complete tasks to enhance your balance, qualify for airdrops, upgrade mine cards, and increase your hourly profit. Invite friends and mine cards to maximize earnings.
            </p>
            </div>
            <div className="w-full flex justify-center pb-7">
            <NavLink 
            to="/tasks"
            className="bg-[#f5bb5f] text-[#5a3d00] w-full py-[18px] px-6 text-nowrap flex items-center justify-center rounded-[12px] font-semibold text-[17px]">
            Start earning $TRACEX
          </NavLink>
          </div>
          </div>
          </div>
