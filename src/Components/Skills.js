                    ...
                    <button
                      ...
                      <div className='flex flex-col items-center justify-center'>
                        ...
                        <span className='text-nowrap text-[10px]'>Profit per hour</span>
                          {currentLevel === 0 ? (
                            <img src='/tracexnewgrey.webp' alt='coingray' className='w-[20px]' />
                          ) : (
                            <img src='/tracexnew.webp' alt='coingray' className='w-[20px]' /> 
                          )}
                    ...
                    <div className='flex items-center justify-center px-3 text-[14px] font-semibold py-[6px]'>
                      ...
                      {nextLevelData ? (
                        <span className='flex items-center space-x-2'>
                          {((index === 5 && userLevels[4] < 2) || (index === 2 && userLevels[3] < 1)) ? (
                            <>
                              <img src='/tracexnewgrey.webp' alt='coin' className='w-[20px]' />
...
<div ref={infoRefTwo} className={`w-full bg-divider shadowtop rounded-tl-[40px] rounded-tr-[40px] relative flex flex-col ease-in duration-300 transition-all justify-center`}>
 ...
 {((selectedUpgrade.index === 5 && userLevels[4] < 2) || (selectedUpgrade.index=== 2 && userLevels[3] < 1)) ? (
               ...
               Unlock required level first
                  ...
                  <span className="text-[#5a3d00]">Upgrade</span>
                      </>
                    )}
            </button>
      ) : (
