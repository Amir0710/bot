...
const Specials = () => {
    const {id, purchasedCards, specialCards, setPurchasedCards, walletAssets, setWalletAssets, deposits, setDeposits, setBalance} = useUser();
    ...
    const handleClick = async () => {
        ...
        try {
            // Define userRef before using it
            const userRef = doc(db, 'telegramUsers', id.toString());  // Reference to the user's Firestore document
            ...
            // Update $TRACEX balance in the state
            ...
            const updatedBalance = currentBalance + selectedCard.profit;
            ...
            setCongratsMessage(
                <div className="w-full flex justify-center flex-col items-center space-y-3">
                    ...
                    <span className="font-medium text-[20px] text-[#ffffff] pt-2 pb-2 flex items-center space-x-1">
                        <img src='/tracexnew.webp' alt='refd' className='w-[25px]'/>
                        <span className={`text-accent`}>{selectedCard.profit}</span> <span>$TRACEX CLAIMED</span>
                    </span>
                    <p className="pb-6 text-[15px] w-full text-center">
                        Your claimed $TRACEX will be kept safe in your wallet till token launch. You can also swap your $TRACEX to other listed assets in the wallets menu.
                    </p>
                </div>
            );
    ...
    return (
        ...
        >
            ...
            <div className="flex items-center space-x-1 pt-1">
                ...
                <img src='/tracexnew.webp' alt='coin' className='w-[20px]' />
                <span className='text-[12px] font-semibold'>
                    {formatNumber(card.profit)} $TRACEX
                </span>
            </div>
            ...
            <div className={`absolute p${card.class} rounded-[15px] left-0 right-0 top-0 bottom-0 flex justify-center flex-col items-center text-center`}>
                ...
                <h2 className='font-medium text-[13px] text-white px-4'>
                    You now owned this special card 😎
                </h2>
                            ...
                            <div className="w-full flex taskbg rounded-tl-[40px] rounded-tr-[40px] mt-[2px] justify-center relative flex-col items-center space-y-3 p-4 pt-20 pb-10">
                                ...
                                <div className="w-full flex justify-center flex-col items-center">
                                    ...
                                    <div className="pb-6 text-primary flex items-center justify-center w-full space-x-1 font-semibold text-[15px] px-4 text-center">
                                       <span> Profit:</span> <span className='pl-1'><img src='tracexnew.webp' alt='dfd' className='w-[20px] h-[20px]'/></span> <span className='text-green-500 '>+{(selectedCard.profit)} $TRACEX</span> 
                                    </div>
                                </div>
