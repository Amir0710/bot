...
<button onClick={() => setShowLevel(true)} className='w-[55%] flex space-x-1 items-center'>
      ...
      <img alt="daxy" src={level.imgUrl} className='w-[20px] levelImg h-full'/>
    ...
    <div className='w-fit py-[2px] px-3 flex items-center space-x-1 justify-center border-[1px] border-cards rounded-[25px]'>
      <span className='w-[20px] levelImg'>
        <img alt="daxy" src='/tracexnew.webp' className='w-full' />
      </span>
...
<div className="pb-1 px-4">
  ...
  className={`${tapValue.level >= tapValues.length ? 'opacity-[.5]' : 'opacity-100'} isolate cardios bg-cards3 w-full rounded-xl relative overflow-hidden p-3 z-10`}
>
  <div className="flex space-x-2 w-full relative">
    {/* Magic Palm Icon */}
    <GiMagicPalm size={45} className="text-btn4 boostImg" />
    ...
    <div className="w-full flex justify-between items-center">
      <div className="font-medium boostTitle text-[15px] flex-1 items-start text-left flex flex-col space-y-[2px]">
        ...
        {/* Level Display */}
        <p className="text-[11px] text-[#d0d0d0] text-left flex items-center space-x-1">
        ...
        <span className="text-btn4 boostAmount font-medium flex items-center justify-between w-full">
          <span className="text-[14px]"> 
            {tapValue.level >= tapValues.length ? (
              <span className="tapguru2">TRACEX</span>
            ) : (
              <span className="tapguru2">{formatNumber(nextUpgradeCost)}</span>
            )}
          </span>
        </span>
      </div>
  ...
  className={`${battery.level >= energyValues.length ? 'opacity-[.5]' : 'opacity-100'} isolate cardios bg-cards3 w-full rounded-xl relative overflow-hidden p-3 z-10`}
>
  <div className="flex space-x-2 w-full relative">
    <MdBatteryCharging90 size={45} className="text-btn4 boostImg" />
        ...
        <span className="text-btn4 boostAmount font-medium flex items-center justify-between w-full">
          <span className="text-[14px]"> 
            {battery.level >= energyValues.length ? (
              ...
              <span className="tapguru2">{formatNumber(nextEnergyUpgradeCost)}</span>
            )}
          </span>
        </span>
      </div>
    ...
    <button 
     ...
     class={`${freeGuru > 0 ? 'opacity-100' : 'opacity-[.5]'} isolate cardios bg-cards3 w-full rounded-xl relative overflow-hidden p-3 z-10`}>
      ...
      <div className="flex space-x-2 w-full relative">
            <ImFire size={45} className="text-btn4 boostImg"/>
              <div className="w-full flex justify-between items-center">
   ...
   <span className="tapguru2">{freeGuru}/3 boosts left</span>
    ...
    <div className="w-full flex justify-between items-center">
          ...
          <button onClick={openit} className="w-full justify-center p-3 flex flex-col space-y-1 bg-cards3 rounded-[12px]">
      {/* <div className="backdrop-blur-[10px] bg-cards absolute left-0 right-0 top-0 bottom-0 z-0 pointer-events-none"/> */}


      <div className="flex space-x-2 w-full relative">
            <PiRocketLaunchFill size={40} className="text-btn4 boostImg"/>

              <div className="w-full flex justify-between items-center">

    
            <div className="font-medium boostTitle text-[15px] flex-1 items-start text-left flex flex-col space-y-[2px]">
             <span> Balance boost card</span>
             <span className="text-[11px] text-[#d0d0d0] text-left flex items-center space-x-1">
            <span>
    ...
    <div className={`${
          ...
          <div className="w-full flex justify-center flex-col items-center space-y-3">
            ...
            Multiply your tap profit by x5 for 20 seconds.
            </p>
          </div>
    ...
    <div ref={infoRefTwo} className={`${
      ...
      {congrats ? (<img src='/congrats.gif' alt="congrats" className="w-[80%]"/>) : (<></>)}
            ...
            <span className="flex items-center space-x-1 !mt-[4px]">
             ...
             Enhance your earnings with every tap. <br/>
